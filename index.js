document.addEventListener("DOMContentLoaded", function () {
  ...
  // return true or false based on Username
  ...
  function updateProgress(solved, total, label, circle) {
    ...
    // Use the calculated percentage to set the CSS custom property.
    circle.style.setProperty("--progress-degree", `${progressDegree}%`);
    label.textContent = `${solved} / ${total}`;
  }

  // To display data of the entered username
  ...
  // Validates the username and fetches LeetCode stats on button click.
